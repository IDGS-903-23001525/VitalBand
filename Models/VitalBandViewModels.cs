...
namespace VitalBand.Models
{
    ...
    public class UsuarioResumenViewModel
    {
        ...
        public string Sexo { get; set; } = string.Empty;   // Mapeado a la columna 'genero' de la BD
        ...
        // 👇 ¡CAMPOS BIOMÉTRICOS Y CLÍNICOS AÑADIDOS PARA COINCIDIR CON LA VISTA!
        public float? Peso { get; set; }                  // Mapeado a 'peso_inicial'
        public float? Altura { get; set; }                // Mapeado a 'altura_inicial'
        public string? HistorialMedico { get; set; }       // Mapeado a 'historial_medico_breve'
    }
